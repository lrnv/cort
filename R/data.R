...
#' \deqn{h_3(u_1,u_2,u_3) = (u_1,\sin(2\pi u_1)-\frac{u_2}{\pi},(1+\frac{u_3}{\pi^{2}})(\frac{u_3}{2}\mathbb{1}_{\frac{1}{4} \ge u_1}  - \sin(\pi^{x_1})    \mathbb{1}_{\frac{1}{4} < u_1}))}
#' to uniformly drawn 3-dimensional random vectors. The dataset is the ranks of \eqn{h_3(u)}.
#'
#' @format A matrix with 500 rows and 3 variables
"funcdep_data"

#' Dataset impossible_data
#'
#' We simulate from a density inside the piecewise linear copula class, by applying the function:
#' \deqn{h_2(u) = (u_1,          \frac{u_2}{2} + \frac{1}{2}\mathbb{1}_{u_1 \notin (\frac{1}{3}, \frac{2}{3})})}
#' to a 200x2 uniform sample, and taking ranks.
#'
#' @format A matrix with 200 rows and 2 variables
"impossible_data"
...
#' \deqn{h_1(u) = (u_1, \frac{u_2 + \mathbb{1}_{u_1 \le \frac{1}{4}} + 2\mathbb{1}_{u_1 \le \frac{1}{2}} + \mathbb{1}_{\frac{3}{4} \le u_1}}{4})}
#'
#'
#' @format A matrix with 500 rows and 2 variables
