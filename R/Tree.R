...
#'
#'
#' @param data The data, must be provided as a matrix with each row as an observation.
          ...
          definition = function(object){
            ...
            model = osqp::osqp(P=P_mat,
                               ...
                               pars=osqp::osqpSettings(rho = 0.1,
                                                 ...
                                                 alpha = 1.6,
                                                 linsys_solver = 1L, #0 for qdldl, 1 for mkl_paradiso
                                                 delta = 1e-06,
                                                 polish = TRUE,
